...
async function loadFeature(feature, editor, config) {
  switch (feature) {
    ...
    case "block-edit" /* BlockEdit */: {
      const { defineFeature } = await Promise.resolve().then(function () { return require('./index-B7gqgc1H.js'); });
      return defineFeature(editor, config);
    }
    ...
    case "toolbar" /* Toolbar */: {
      const { defineFeature } = await Promise.resolve().then(function () { return require('./index-DGAwtnNK.js'); });
      return defineFeature(editor, config);
    }
    case "table" /* Table */: {
    ...
    case "latex" /* Latex */: {
      const { defineFeature } = await Promise.resolve().then(function () { return require('./index-CoTb-QdE.js'); });
      return defineFeature(editor, config);
    }
  }
}
...
//# sourceMappingURL=index-CnyNb_OH.js.map
