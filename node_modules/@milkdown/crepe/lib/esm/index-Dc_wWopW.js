import { EditorStatus, Editor, rootCtx, defaultValueCtx, editorViewOptionsCtx } from '@milkdown/kit/core';
...
async function loadFeature(feature, editor, config) {
  switch (feature) {
    ...
    case "block-edit" /* BlockEdit */: {
      const { defineFeature } = await import('./index-CM4urRY9.js');
      return defineFeature(editor, config);
    }
    ...
    case "toolbar" /* Toolbar */: {
      const { defineFeature } = await import('./index-BAQT-9au.js');
      return defineFeature(editor, config);
    }
    case "table" /* Table */: {
    ...
    case "latex" /* Latex */: {
      const { defineFeature } = await import('./index-BDZ_pnSv.js');
      return defineFeature(editor, config);
    }
  }
}
...
//# sourceMappingURL=index-Dc_wWopW.js.map
